...
namespace NDMFMerge.Runtime
{
    ...
    public class OutfitToMerge
    {
        ...
        // ---- Per-outfit animator toggles (no Header here; prevents duplication in default inspector) ----

        [Space(6)]
        [Tooltip("Merge this outfit's Animator into the target. Uses Actual Animator if present, else Base Animator. Skips AAS autogenerated layers.")]
        [InspectorName("Merge Animator (skip AAS auto-layers)")]
        public bool mergeAnimator = false;

        [Tooltip("Merge this outfit's Animator into the target INCLUDING AAS autogenerated layers.")]
        [InspectorName("Merge Animator (include AAS auto-layers)")]
    ...
    public class CVRMergeArmature : MonoBehaviour
    {
        ...
        [Tooltip("Master toggle: if off, no outfit animators will be merged regardless of per-outfit toggles.")]
